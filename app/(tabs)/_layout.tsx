...
export default function TabLayout() {
  const inset = useSafeAreaInsets(); const { t } = useI18n(); const { width } = useWindowDimensions(); const desktopWeb = Platform.OS === "web" && width >= 900; const bottom = Platform.OS === "web" ? 12 : Math.max(10, inset.bottom);
