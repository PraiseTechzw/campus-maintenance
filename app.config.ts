...
const env = { appName: "Campus Maintenance", appSlug: "campus-maintenance", logoUrl: "/manus-storage/campus-maintenance-icon_dbbaf2df.png", scheme: `manus${timestamp}`, iosBundleId: bundleId, androidPackage: bundleId };
...
const config: ExpoConfig = {
  ...
  android: { adaptiveIcon: { backgroundColor: "#FFFFFF", foregroundImage: "./assets/images/android-icon-foreground.png", backgroundImage: "./assets/images/android-icon-background.png", monochromeImage: "./assets/images/android-icon-monochrome.png" }, edgeToEdgeEnabled: true, predictiveBackGestureEnabled: false, package: env.androidPackage, permissions: ["POST_NOTIFICATIONS"], intentFilters: [{ action: "VIEW", autoVerify: true, data: [{ scheme: env.scheme, host: "*" }], category: ["BROWSABLE", "DEFAULT"] }] },
  web: { bundler: "metro", output: "static", favicon: "./assets/images/favicon.png" },
  plugins: [
    "expo-router",
    ["expo-image-picker", { photosPermission: "Allow Campus Maintenance to access a photo of the issue.", cameraPermission: "Allow Campus Maintenance to take a photo of the issue." }],
    ["expo-notifications", { icon: "./assets/images/android-icon-monochrome.png", color: "#082B73", defaultChannel: "campus-urgent" }],
