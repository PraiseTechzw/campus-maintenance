...
export type Request = { id: string; title: string; category: Category; location: string; description: string; priority: Priority; status: Status; reporter: string; team: Team; assignee?: string; time: string; activity: Activity[]; acknowledged?: boolean; satisfaction?: 1 | 2 | 3; attachmentUri?: string; arrivalTime?: string };

export const roles: Record<Role, { label: string; summary: string; initials: string; team?: Team; name: string }> = campusRoles;

const seed: Request[] = [
  { id: "CM-2418", title: "Wi-Fi unavailable in Computer Lab 2", category: "ICT", location: "Technology Block · Computer Lab 2", description: "The classroom network is unavailable on all student workstations.", priority: "High", status: "Assigned", reporter: "Amara N.", team: "ICT", assignee: "Jordan M.", arrivalTime: "Today, 10:15", time: "Today, 09:10", activity: [{ id: "1", action: "Request submitted", author: "Amara N.", time: "Today, 08:34" }, { id: "2", action: "Assigned to ICT", author: "Campus Admin", time: "Today, 09:10", note: "Assigned to Jordan M." }, { id: "2a", action: "Technician arrival updated", author: "Jordan M.", time: "Today, 09:14", note: "Expected arrival: Today, 10:15." }] },
